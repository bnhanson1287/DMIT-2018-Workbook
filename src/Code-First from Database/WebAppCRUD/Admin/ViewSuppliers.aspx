...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="SuppliersListView" runat="server" DataSourceID="SuppliersDataSource" InsertItemPosition="FirstItem" OnItemInserting="SuppliersListView_ItemInserting" OnItemInserted="SuppliersListView_ItemInserted" ItemType="WestWindSystem.Entities.Supplier">
        <LayoutTemplate>
